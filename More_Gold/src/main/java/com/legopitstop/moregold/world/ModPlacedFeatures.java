package com.legopitstop.moregold.world;
...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        // NORMAL
        register(context, TREES_GOLDEN_FRUIT, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.GOLDEN_FRUIT),
        ...
        // BEES
        register(context, GOLDEN_FRUIT_BEES_005_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.GOLDEN_FRUIT_BEES_005),
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(MoreGold.MOD_ID, name));
    }
