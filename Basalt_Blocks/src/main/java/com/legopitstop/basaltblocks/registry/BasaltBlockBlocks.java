...
public class BasaltBlockBlocks {
    ...
    public static final Block BASALT_BUTTON = new ButtonBlock(BlockSetType.STONE, 30, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block BASALT_PRESSURE_PLATE = new PressurePlateBlock(BlockSetType.STONE,  FabricBlockSettings.copyOf(Blocks.BASALT));
    ...
    public static final Block SMOOTH_BASALT_BUTTON = new ButtonBlock(BlockSetType.STONE, 30, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block SMOOTH_BASALT_PRESSURE_PLATE = new PressurePlateBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.BASALT));
    ...
    public static final Block POLISHED_BASALT_BUTTON = new ButtonBlock(BlockSetType.STONE, 30, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block POLISHED_BASALT_PRESSURE_PLATE = new PressurePlateBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block POLISHED_BASALT_BRICK_DOOR = new DoorBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block POLISHED_BASALT_BRICK_TRAPDOOR = new TrapdoorBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.BASALT));
    ...
    public static final Block POLISHED_BASALT_BRICK_BUTTON = new ButtonBlock(BlockSetType.STONE, 30, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block POLISHED_BASALT_BRICK_PRESSURE_PLATE = new PressurePlateBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.BASALT));
    ...
    public static final Block COBBLED_BASALT_BUTTON = new ButtonBlock(BlockSetType.STONE, 30, FabricBlockSettings.copyOf(Blocks.BASALT));
    public static final Block COBBLED_BASALT_PRESSURE_PLATE = new PressurePlateBlock(BlockSetType.STONE, FabricBlockSettings.copyOf(Blocks.BASALT));
