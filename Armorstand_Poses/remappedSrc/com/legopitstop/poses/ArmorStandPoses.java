...
import com.legopitstop.poses.server.pose.ArmorStandPoseLoader;
...
public class ArmorStandPoses implements ModInitializer {
	...
	public void onInitialize() {
		ResourceManagerHelper.get(ResourceType.SERVER_DATA).registerReloadListener(new ArmorStandPoseLoader());
	}
}